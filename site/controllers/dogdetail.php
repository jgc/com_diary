 ...
 */
class DiaryControllerDogdetail extends DiaryController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Dogdetail', 'DiaryModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_diary&view=dogdetailform&layout=edit', false));
	}
