 ...
 */
class DiaryControllerDiaryname extends DiaryController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Diaryname', 'DiaryModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_diary&view=diarynameform&layout=edit', false));
	}
