...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-diaryname').submit(function(event){
...
$nheading = '<h2 class="item-title">Add dog name</h2>';}

if ((empty($pheading)) and (!empty($this->item->id))) {
//$nheading = '<h1>Edit diary entry '.$this->item->id.'</h1>';}
$nheading = '<h2 class="item-title">Edit dog name</h2>';}
...
<div class="diaryname-edit front-end-edit"> 
    ...
    <form id="form-diaryname" action="<?php echo JRoute::_('index.php?option=com_diary&task=diaryname.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('rname'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('rname'); ?></div>
			</div>
                        
                        <div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('rnumber'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('rnumber'); ?></div>
			</div>
        ...
        <div>
            ...
            <input type="hidden" name="task" value="diarynameform.save" />
